...
--2.	To create table in the database.
	CREATE TABLE cloudtechdb.top2gpoststb (Body string, Score int, Id int, ViewCount int, OwnerUserId int, OwnerDisplayName string, Title string, Tags string) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',';
